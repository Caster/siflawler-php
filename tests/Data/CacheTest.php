...
class CacheTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testCrawlMulti() {
        ...
        list($data, $visited) = $crawler->crawl(
            'http://www.rijdendetreinen.nl/storingen/p593', true);
        ...
        $this->assertEquals(14, count($visited));
        $visited_expected = array(
            ...
            'http://www.rijdendetreinen.nl/storingen/p593'
        );
        for ($i = 0; $i < 10; $i++) {
